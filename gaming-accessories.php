...
<?php
    ...
    $query = "SELECT * FROM product WHERE catName='Accessories' and isDeleted='no'";
...
<head>
    ...
    <title>Gaming Accessories - Arcade Alley</title>
...
<body>
    ...
    <main class="content">
        <div class="category-products">
            ...
            <h4><a href="home.php">Home</a> > Gaming Accessories </h4>
